...
const products = [
  {
    ...
    description:
      'Scholarship-supported retreat experience with minimal financial assistance',
    price: 800,
    image: 'product2.jpg',
    quantity: 1,
    type: 'Limited Scholarship',
  },
];

export default function ScholarshipThree() {
  ...
  if (selectedProduct) {
    return (
      <>
        <Head>
          <title>Scholarship Checkout | Sacred Feminine</title>
        </Head>
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-[#666666] text-lg max-w-2xl mx-auto font-light">
                Review your scholarship-supported retreat registration
              </p>
            </div>
  ...
  return (
    <>
      <Head>
        <title>Scholarship Registration | Sacred Feminine</title>
      </Head>
      <div className="min-h-screen bg-gradient-to-b from-[#f8f3ef] to-[#f0e9e4] py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-[#666666] text-lg max-w-2xl mx-auto font-light">
              Complete your scholarship-supported retreat registration
            </p>
          </div>
