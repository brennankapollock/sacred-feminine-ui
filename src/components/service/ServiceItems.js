...
const services = [
  {
    ...
    name: 'Details',
    text: [
      'Our retreat will begin around 5pm the 13th, but you are welcome to arrive anytime after 4pm. The retreat will end at 11am on the 15th, and we ask that all participants be there until that time.',
  ...
  },
  {
    ...
    text: [
      'We will have limited on site accommodations for those of you who are interested. This will be a "first come first serve” basis, so please let us know as soon as you can if you would like a bed on site.',
      'If you request a room in your email and there is space still available we will let you know. Here is the cost breakdown for an on-site room for the entirety of the retreat:',
      ...
      'There you can coordinate accommodation or travel with others coming to the retreat.',
